...
svf-workspace-validate: svf-registry-validate svf-runner-list svf-runner-select-smoke svf-runner-verify-receipt-smoke
	@echo "OK: svf-workspace-validate"

# --- registry targets ---
.PHONY: registry-validate registry-admissions-validate ontology-validate dep-cycles mirror-drift-check build-intelligence-validate deployment-topology-validate contract-lock-validate
...
registry-validate: registry-admissions-validate
