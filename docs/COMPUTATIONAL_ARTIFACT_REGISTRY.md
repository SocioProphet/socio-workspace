...
python3 tools/computational_artifact_health_report.py

# Emit a human-readable table
python3 tools/computational_artifact_health_report.py --table

# Write the report to a file
python3 tools/computational_artifact_health_report.py --output /tmp/artifact-health-report.json
```
...
3. Run `python3 tools/validate_computational_artifacts.py` to confirm the entry is valid.
4. Run `python3 tools/computational_artifact_health_report.py --table` to
