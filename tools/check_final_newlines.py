...
CHECKED = [
    ...
    "registry/neurosymbolic-repo-graph-reasoner/fixtures/invalid.repo-governance-observation.missing-source-sha.v0.json",
    "registry/neurosymbolic-repo-graph-reasoner/fixtures/valid.active-spine.repo-graph.findings.json",
    "registry/neurosymbolic-repo-graph-reasoner/fixtures/valid.repo-governance-observations.v0.json",
    ...
    "tools/check_repo_governance_observations.py",
